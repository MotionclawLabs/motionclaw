            ...
            {projectsList.map((d, index) => (
              <div className="my-2 grid items-start gap-8" key={index}>
                <div className="group relative transform transition duration-500 hover:scale-105">
                  <div className="animate-tilt absolute -inset-0.5 rounded-lg bg-gradient-to-r from-blue-600 to-purple-500 opacity-25 blur transition duration-1000 group-hover:opacity-100 group-hover:duration-500"></div>
